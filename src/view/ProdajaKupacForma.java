...
public class ProdajaKupacForma extends JFrame {
	...
	public ProdajaKupacForma(String user, int idZaposleni) {
		this.user = user;
		...
		scrollPane.setBounds(10, 154, 550, 365);
		...
		tfPretraga.setBounds(150, 104, 220, 26);
		...
		tfCena.setBounds(703, 242, 117, 31);
		...
		lblOpcija.setBounds(593, 203, 57, 29);
		contentPane.add(lblOpcija);

		tfModel = new JTextField();
		tfModel.setBorder(roundedBorder);
		tfModel.setFont(new Font("Tahoma", Font.PLAIN, 24));
		tfModel.setBounds(703, 158, 117, 31);
		contentPane.add(tfModel);
		tfModel.setColumns(10);
		
		
		JButton btnNewButton = new JButton("Vidi Korpu");
		btnNewButton.setBackground(Color.WHITE);
		Image img4 = new ImageIcon(this.getClass().getResource("/korpa.png")).getImage();
		btnNewButton.setIcon(new ImageIcon(img4));
		btnNewButton.setBorder(roundedBorder);
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ProdavacKorpaForma pkf = new ProdavacKorpaForma(idZaposleni);
				pkf.setVisible(true);
				dispose();
			}
		});
		btnNewButton.setFont(new Font("Myriad Pro Light", Font.PLAIN, 24));
		btnNewButton.setBounds(593, 536, 227, 50);
